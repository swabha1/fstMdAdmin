<header class="main-header">
        ...
        <a href="<?php echo site_url(_get_user_redirect($this)); ?>" class="logo">
          ...
          <span class="logo-mini"><b><?php echo $this->config->item("company_title");?></b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b> <?php echo $this->config->item("company_title");?></b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                   <div class="pull-left">  
                         <a href="<?php echo site_url("users/edit_user/"._get_current_user_id($this)); ?>"  class="btn btn-default btn-flat"> Edit Profile </a>
                    </div>
