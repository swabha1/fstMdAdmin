                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="offer_title" class="form-control" placeholder="Title"/>    
                                         </div>
                                         <div class="form-group">
                                                <label class="">Description : <span class="text-danger">*</span></label> 
                                                <input type="text" name="offer_description" class="form-control" placeholder="Description" />    
                                         </div>
                                      ...
                                      <div class="form-group">
                                            ...
                                            <input type="text" name="offer_coupon" class="form-control" placeholder="CODE15" />    
                                     </div>
